...
public class RetrieveReviewByIDRequest implements Runnable{

	private StaticObjects staticObjects;
	private int reviewID;
	
	public RetrieveReviewByIDRequest(int reviewID)
	{
	...
	public void run() {
		...
		httpget = new HttpGet("http://petsociety.cloudapp.net/api/RetrieveReview?INtoken="+staticObjects.getToken()+"&INreviewID="+this.reviewID); 
