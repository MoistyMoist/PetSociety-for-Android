...
public class RetrieveAllLocationRequest implements Runnable{

	private StaticObjects staticObjects;
	
	public RetrieveAllLocationRequest()
	{
	...
	public void run() {
		...
		httpget = new HttpGet("http://petsociety.cloudapp.net/api/RetrieveLocation?INtoken="+staticObjects.getToken()); 
