...
public class RetrieveReviewByUserRequest implements Runnable{

	private StaticObjects staticObjects;
	private int userID;
	
	public RetrieveReviewByUserRequest(int userID)
	{
		this.userID=userID;
	...
	public void run() {
		...
		httpget = new HttpGet("http://petsociety.cloudapp.net/api/RetrieveReview?INtoken="+staticObjects.getToken()+"&INuserID="+this.userID); 
