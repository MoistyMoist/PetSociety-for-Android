...
public class RetrieveReviewByStrayRequest implements Runnable{

	private StaticObjects staticObjects;
	private int strayID;
	
	public RetrieveReviewByStrayRequest(int strayID)
	{
	...
	public void run() {
		...
		httpget = new HttpGet("http://petsociety.cloudapp.net/api/RetrieveReview?INtoken="+staticObjects.getToken()+"&INstrayID="+this.strayID); 
