...
public class RetrieveLocationByUserRequest implements Runnable{

	private StaticObjects staticObjects;
	private int userID;
	
	public RetrieveLocationByUserRequest(int userID)
	{
		this.userID=userID;
	...
	public void run() {
		...
		httpget = new HttpGet("http://petsociety.cloudapp.net/api/RetrieveLocation?INtoken="+staticObjects.getToken()+"&INuserID="+this.userID); 
