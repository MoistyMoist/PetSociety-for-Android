...
public class RetrieveStrayByTypeRequest implements Runnable{

	private StaticObjects staticObjects;
	private String type;
	
	public RetrieveStrayByTypeRequest(String type)
	{
		this.type=type;
	...
	public void run() {
		...
		httpget = new HttpGet("http://petsociety.cloudapp.net/api/RetrieveStray?INtoken="+staticObjects.getToken()+"&INtype="+this.type); 
