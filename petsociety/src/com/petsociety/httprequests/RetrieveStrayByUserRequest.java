...
public class RetrieveStrayByUserRequest implements Runnable{

	private StaticObjects staticObjects;
	private int userID;
	
	public RetrieveStrayByUserRequest(int userID)
	{
		this.userID=userID;
	...
	public void run() {
		...
		httpget = new HttpGet("http://petsociety.cloudapp.net/api/RetrieveStray?INtoken="+staticObjects.getToken()+"&INuserID="+this.userID); 
