...
public class RetrieveStrayByDateTimeSeenRequest implements Runnable{

	private StaticObjects staticObjects;
	private Date dateTimeSeen;
	
	public RetrieveStrayByDateTimeSeenRequest(Date dateTimeSeen)
	{
	...
	public void run() {
		...
		httpget = new HttpGet("http://petsociety.cloudapp.net/api/RetrieveStray?INtoken="+staticObjects.getToken()+"&INdateTimeSeen="+this.dateTimeSeen.toString()); 
