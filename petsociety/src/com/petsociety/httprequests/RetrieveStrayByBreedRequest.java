...
public class RetrieveStrayByBreedRequest implements Runnable{

	private StaticObjects staticObjects;
	private String breed;
	
	public RetrieveStrayByBreedRequest(String breed)
	{
		this.breed=breed;
	...
	public void run() {
		...
		httpget = new HttpGet("http://petsociety.cloudapp.net/api/RetrieveStray?INtoken="+staticObjects.getToken()+"&INbreed="+this.breed); 
