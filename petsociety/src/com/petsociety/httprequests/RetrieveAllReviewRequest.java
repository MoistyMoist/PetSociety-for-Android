...
public class RetrieveAllReviewRequest implements Runnable{

	private StaticObjects staticObjects;
	
	public RetrieveAllReviewRequest()
	{
	...
	public void run() {
		...
		httpget = new HttpGet("http://petsociety.cloudapp.net/api/RetrieveReview?INtoken="+staticObjects.getToken()); 

        Log.i("RETRIEVE ALL REVIEW :",httpget.getURI().toString());
